...
export const demoProductos: Producto[] = [
  { id: 'prod-1', categoria_id: 'cat-tortas', subcategoria_id: null, nombre: 'Torta de chocolate húmeda', slug: 'torta-chocolate-humeda', descripcion: 'Bizcocho húmedo de cacao con fudge casero.', precio_venta: 95, costo_unitario: 42.5, margen: 52.5, stock_actual: 8, stock_minimo: 3, oferta_activa: false, oferta_precio: null, oferta_fecha_fin: null, disponible: true, destacado: true, tiempo_preparacion_min: 180, created_at: now, updated_at: now },
  { id: 'prod-2', categoria_id: 'cat-tortas', subcategoria_id: null, nombre: 'Torta de vainilla con frutos rojos', slug: 'torta-vainilla-frutos-rojos', descripcion: 'Vainilla artesanal con crema ligera y frutos rojos.', precio_venta: 110, costo_unitario: 48, margen: 62, stock_actual: 3, stock_minimo: 3, oferta_activa: true, oferta_precio: 89, oferta_fecha_fin: new Date(Date.now() + 2 * 86400000).toISOString(), disponible: true, destacado: true, tiempo_preparacion_min: 210, created_at: now, updated_at: now },
  { id: 'prod-3', categoria_id: 'cat-cupcakes', subcategoria_id: null, nombre: 'Cupcakes surtidos x12', slug: 'cupcakes-surtidos-x12', descripcion: 'Docena de cupcakes de vainilla, chocolate y red velvet.', precio_venta: 72, costo_unitario: 29.4, margen: 42.6, stock_actual: 0, stock_minimo: 3, oferta_activa: false, oferta_precio: null, oferta_fecha_fin: null, disponible: true, destacado: false, tiempo_preparacion_min: 120, created_at: now, updated_at: now },
  { id: 'prod-4', categoria_id: 'cat-postres', subcategoria_id: null, nombre: 'Cheesecake de maracuyá', slug: 'cheesecake-maracuya', descripcion: 'Cheesecake cremoso con salsa de maracuyá natural.', precio_venta: 88, costo_unitario: 36.2, margen: 51.8, stock_actual: 6, stock_minimo: 3, oferta_activa: false, oferta_precio: null, oferta_fecha_fin: null, disponible: true, destacado: true, tiempo_preparacion_min: 150, created_at: now, updated_at: now },
];
